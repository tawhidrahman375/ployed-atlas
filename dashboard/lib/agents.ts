...
export const AGENTS: AgentMeta[] = [
  ...
  { key: 'echo', name: 'Echo', role: 'Queues cold email into Saleshandy (delivery depends on Saleshandy’s own send schedule/warmup)', color: '#34d399' },
  ...
  { key: 'pulse', name: 'Pulse', role: 'Pulls GSC, PostHog and Saleshandy analytics', color: '#22d3ee' },
